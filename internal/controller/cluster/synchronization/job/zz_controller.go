...
import (
	...
	v1beta1 "github.com/upbound/provider-azuread/v2/apis/cluster/synchronization/v1beta1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.Job_GroupVersionKind)))
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["azuread_synchronization_job"],
	...
	// register webhooks for the kind v1beta1.Job
	// if they're enabled.
	if o.StartWebhooks {
