...
import (
	...
	v1beta1 "github.com/upbound/provider-azuread/apis/cluster/applications/v1beta1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewTerraformPluginSDKConnector(mgr.GetClient(), o.SetupFn, o.Provider.Resources["azuread_application"], o.OperationTrackerStore,
			tjcontroller.WithTerraformPluginSDKLogger(o.Logger),
			tjcontroller.WithTerraformPluginSDKMetricRecorder(metrics.NewMetricRecorder(v1beta1.Application_GroupVersionKind, mgr, o.PollInterval)),
